...
export const partners = [
  ...
  { name: 'Edelweiss Air', iata: 'WK', relationship: 'Representation & Supervision', period: '2010–present', website: 'https://flyedelweiss.com', current: true, type: 'airline' as const },
  { name: 'Air Serbia', iata: 'JU', relationship: 'Supervision & Ticketing', period: '2015–present', website: 'https://airserbia.com', current: true, type: 'airline' as const },
  { name: 'LOT Polish Airlines', iata: 'LO', relationship: 'Ticketing', period: '2018–present', website: 'https://lot.com', current: true, type: 'airline' as const },
  { name: 'Turkish Airlines', relationship: 'Ticketing', period: '2023–present', website: 'https://turkishairlines.com', current: true, type: 'airline' as const },
  // Vendor partners
  { name: 'Amadeus', relationship: 'GDS Market Support', period: '1998–present', website: 'https://amadeus.com', current: true, type: 'vendor' as const },
  { name: 'Jetex Dubai', relationship: 'Airport Support', period: '2008–present', website: 'https://jetex.com', current: true, type: 'vendor' as const },
  { name: 'Apogee Dubai', relationship: 'Airport Support', period: '2011–present', website: 'https://apogee.aero', current: true, type: 'vendor' as const },
  { name: 'Flight Pro International', relationship: 'Airport Support', period: '2019–present', website: 'https://flightprointernational.com', current: true, type: 'vendor' as const },
  { name: 'World Fuel Services', relationship: 'Fuel Arrangements', period: '', website: 'https://world-kinect.com', current: true, type: 'vendor' as const },
  { name: 'Rockwell Collins', relationship: 'Airport Support', period: '1998–2019', website: 'https://collinsaerospace.com', current: false, type: 'vendor' as const },
  // Historical
  { name: 'Swiss International', relationship: 'GSA & Supervision', period: '1997–2006', website: 'https://swiss.com', current: false, type: 'airline' as const },
  { name: 'Adria Airways', relationship: 'GSA & Supervision', period: '1995–2019', website: '', current: false, type: 'airline' as const },
];
