export const meta = {
  title: 'Contact AAM Airport Services | Skopje, Macedonia',
  description: 'Get in touch with AAM Airport Services for ground handling partnerships, agency enquiries, corporate travel or general questions.',
};
